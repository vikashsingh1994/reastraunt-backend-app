...
const Auth1Model = require('./../models/Auth')
const User1Model = require('./../models/User')
...
} // end getAllUserDetails function
...
let signUpFunction = (req, res) => {
    ...
    validateUserInput(req, res)
        ...
        .then((user_details) => {
            ...
            let apiResponse = response.generate(false, 'User created', 200, user_details)
            res.send(apiResponse)
        })
        .catch((err) => {
            console.log(err);
